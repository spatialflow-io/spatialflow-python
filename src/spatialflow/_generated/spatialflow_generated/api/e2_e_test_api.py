...
class E2ETestApi:
    ...
    @validate_call
    async def apps_test_api_cleanup_e2e_data(
        self,
        ...
        _param = self._apps_test_api_cleanup_e2e_data_serialize(
    ...
    @validate_call
    async def apps_test_api_cleanup_e2e_data_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def apps_test_api_cleanup_e2e_data_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _apps_test_api_cleanup_e2e_data_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
