...
class WebhookDeliveryDetailResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "webhook_id", "geofence_id", "event_type", "event_id", "url", "method", "status", "response_status_code", "response_status", "response_time_ms", "error_message", "attempt_count", "retry_count", "created_at", "delivered_at", "next_retry_at", "payload", "response_body", "response_headers"]
