...
class SignupRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["email", "password", "name", "company", "use_case", "selected_plan", "utm_source", "utm_medium", "utm_campaign", "utm_term", "utm_content", "website"]

    @field_validator('selected_plan')
    def selected_plan_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
