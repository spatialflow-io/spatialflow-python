...
class UpdateOnboardingProgressRequest(BaseModel):
    ...
    """ # noqa: E501
    step: StrictStr = Field(description="Step to mark as complete: created_workflow, created_geofence, tested_simulator, added_device")
    __properties: ClassVar[List[str]] = ["step"]
