...
class EnhancedWorkspaceListItem(BaseModel):
    """
    ...
    usage_this_month: Optional[Union[StrictFloat, StrictInt]] = 0.0
    last_activity: Optional[StrictStr] = None
    created_at: Optional[StrictStr]
    updated_at: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["id", "name", "slug", "billing_email", "website", "logo_url", "timezone", "member_count", "subscription_tier", "subscription_status", "usage_this_month", "last_activity", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "usage_this_month": obj.get("usage_this_month") if obj.get("usage_this_month") is not None else 0.0,
