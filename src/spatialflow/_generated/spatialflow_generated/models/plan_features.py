...
class PlanFeatures(BaseModel):
    ...
    feature_list: Optional[List[StrictStr]] = Field(default=None, description="Feature list from model")
    __properties: ClassVar[List[str]] = ["api_calls", "geofences", "webhooks", "test_points", "support", "custom_domains", "sla", "feature_list"]
