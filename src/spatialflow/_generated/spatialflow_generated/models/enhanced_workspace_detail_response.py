...
class EnhancedWorkspaceDetailResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "slug", "billing_email", "website", "logo_url", "timezone", "stripe_customer_id", "member_count", "subscription", "usage", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscription": SubscriptionInfo.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None,
            "usage": UsageLimits.from_dict(obj["usage"]) if obj.get("usage") is not None else None,
