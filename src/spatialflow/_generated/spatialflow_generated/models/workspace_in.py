...
class WorkspaceIn(BaseModel):
    ...
    unit_system: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "logo_url", "website", "billing_email", "description", "timezone", "support_email", "slack_connect_url", "unit_system"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if unit_system (nullable) is None
        # and model_fields_set contains the field
        if self.unit_system is None and "unit_system" in self.model_fields_set:
            _dict['unit_system'] = None
