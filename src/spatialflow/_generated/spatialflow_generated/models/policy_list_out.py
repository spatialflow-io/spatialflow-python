...
class PolicyListOut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["policies", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policies": [PolicyOut.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None,
