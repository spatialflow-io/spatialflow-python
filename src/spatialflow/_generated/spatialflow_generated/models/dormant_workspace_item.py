...
class DormantWorkspaceItem(BaseModel):
    """
    ...
    inactive_days: StrictInt
    created_at: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["id", "name", "slug", "member_count", "subscription_tier", "last_activity", "inactive_days", "created_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inactive_days": obj.get("inactive_days"),
