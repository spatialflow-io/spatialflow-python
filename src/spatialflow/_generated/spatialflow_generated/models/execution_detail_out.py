...
class ExecutionDetailOut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "workflow_id", "workflow_name", "execution_id", "trigger_source", "trigger_data", "status", "current_step", "error_message", "started_at", "completed_at", "duration_seconds", "steps"]
