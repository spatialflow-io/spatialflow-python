...
class LocationBatchIn(BaseModel):
    ...
    """ # noqa: E501
    locations: List[LocationPointIn]
    idempotency_key: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["locations", "idempotency_key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "locations": [LocationPointIn.from_dict(_item) for _item in obj["locations"]] if obj.get("locations") is not None else None,
