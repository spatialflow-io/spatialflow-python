...
class IntegrationDetailSchema(BaseModel):
    """
    ...
    config: Dict[str, Any]
    __properties: ClassVar[List[str]] = ["id", "name", "type", "description", "is_active", "is_verified", "health_status", "health_message", "usage_count", "last_used_at", "last_verified_at", "tags", "created_at", "updated_at", "config"]
