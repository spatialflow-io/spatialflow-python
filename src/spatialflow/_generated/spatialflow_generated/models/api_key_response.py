...
class ApiKeyResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "key_prefix", "permissions", "is_active", "usage_count", "rate_limit_per_hour", "last_used_at", "created_at", "read_only", "description", "workspace_id", "expires_at"]
