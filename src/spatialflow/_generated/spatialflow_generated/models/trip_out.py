...
class TripOut(BaseModel):
    ...
    created_at: datetime
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["id", "device_id", "device_name", "status", "name", "start_time", "end_time", "duration_seconds", "distance_meters", "session_id", "has_planned_route", "has_track_geometry", "metadata", "created_at", "updated_at"]
