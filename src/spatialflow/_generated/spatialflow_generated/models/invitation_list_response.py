...
class InvitationListResponse(BaseModel):
    ...
    total: StrictInt
    __properties: ClassVar[List[str]] = ["invitations", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invitations": [InvitationOut.from_dict(_item) for _item in obj["invitations"]] if obj.get("invitations") is not None else None,
            "total": obj.get("total")
        })
        return _obj
