...
------------- | ------------- | -------------
[**apps_public_locations_api_get_ingest_stats**](PublicLocationIngestApi.md#apps_public_locations_api_get_ingest_stats) | **GET** /api/v1/locations/stats | Get Ingest Stats
[**apps_public_locations_api_ingest_location**](PublicLocationIngestApi.md#apps_public_locations_api_ingest_location) | **POST** /api/v1/locations | Ingest Location
[**apps_public_locations_api_ingest_location_batch**](PublicLocationIngestApi.md#apps_public_locations_api_ingest_location_batch) | **POST** /api/v1/locations/batch | Ingest Location Batch
